          ...
          <div className="container grid items-center justify-center gap-4 px-4 text-center md:px-6 lg:gap-10">
            ...
            <div className="grid w-full grid-cols-1 gap-8 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
              ...
              <Card className="flex flex-col justify-between">
                ...
                <CardContent>
                  <blockquote className="text-muted-foreground">
                    "I've traveled for work for years, and I've never felt more secure than I do now with Scam
                    Awareness. The alerts help me stay one step ahead!"
                  </blockquote>
                </CardContent>
              </Card>
              <Card className="flex flex-col justify-between">
                ...
                <CardContent>
                  <blockquote className="text-muted-foreground">
                    "Traveling with my kids can be stressful, but Scam Awareness has given me peace of mind. I feel
                    like I have a safety net while exploring new places."
                  </blockquote>
                </CardContent>
              </Card>
            </div>
